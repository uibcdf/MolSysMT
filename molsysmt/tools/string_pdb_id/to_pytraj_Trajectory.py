def to_pytraj_Trajectory(item, atom_indices='all', structure_indices='all', check_form=True):
    ...
    tmp_item = molsysmt_MolSys_to_pytraj_Trajectory(tmp_item, check_form=False)
