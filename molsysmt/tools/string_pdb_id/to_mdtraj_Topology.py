def to_mdtraj_Topology(item, atom_indices='all', structure_indices='all', check_form=True):
    ...
    tmp_item = molsysmt_MolSys_to_mdtraj_Topology(tmp_item, check_form=False)
