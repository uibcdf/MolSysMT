def to_pdbfixer_PDBFixer(item, atom_indices='all', model_indices='all', check_form=True):
    ...
    tmp_item = molsysmt_MolSys_to_pdbfixer_PDBFixer(tmp_item, check_form=True)
