def to_openmm_Topology(item, atom_indices='all', model_indices='all', check_form=True):
    ...
    from molsysmt.tools.molsysmt_MolSys import to_openmm_Modeller as molsysmt_MolSys_to_openmm_Topology

    tmp_item = string_pdb_id_to_molsysmt_MolSys(item, atom_indices=atom_indices, model_indices=frame_indices, check_form=False)
    tmp_item = molsysmt_MolSys_to_openmm_Topology(tmp_item, check_form=False)
