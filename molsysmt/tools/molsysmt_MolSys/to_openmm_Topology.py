def to_openmm_Topology(item, atom_indices='all', frame_indices='all', check_form=True):
    ...
    box = get_box_from_system(item, frame_indices=frame_indices, check_form=False)
