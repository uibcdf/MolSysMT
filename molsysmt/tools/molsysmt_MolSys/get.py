...
def get_atom_index_from_atom(item, indices='all', check=True):
    ...
    return _get(item.topology, indices=indices, check=False)
...
def get_coordinates_from_atom(item, indices='all', structure_indices='all', check=True):
    ...
    return _get(item.structures, indices=indices, structure_indices=structure_indices, check=False)

def get_n_structures_from_atom(item, structure_indices='all', check=True):

    _checking_form(item, check)

    from molsysmt.tools.molsysmt_Structures import get_n_structures_from_atom as _get
    return _get(item.structures, structure_indices=structure_indices, check=False)
...
def get_bonded_atoms_from_system(item, check=True):
    ...
    return _get(item.topology, check=False)
...
def get_box_from_system(item, structure_indices='all', check=True):
    ...
    return _get(item.trajectory, structure_indices=structure_indices, check=False)
...
def get_box_lengths_from_system(item, structure_indices='all', check=True):
    ...
    if tmp_box_lengths is not None and structure_indices is not 'all':
        tmp_box_lengths = tmp_box_lengths[structure_indices,:]
...
def get_box_angles_from_system(item, structure_indices='all', check=True):
    ...
    if tmp_box_angles is not None and structure_indices is not 'all':
        tmp_box_angles = tmp_box_angles[structure_indices,:]
...
def get_box_volume_from_system(item, structure_indices='all', check=True):
    ...
    tmp_box = get_box_from_system(item, indices=indices, structure_indices=structure_indices, check=False)
...
def get_n_structures_from_system(item, check=True):
    ...
    return _get(item.structures, check=False)
