...
def get_box_lengths_from_system(item, structure_indices='all', check=True):
    ...
    from molsysmt.tools.molsysmt_Structures import get_box_lengths_from_system as _get
    return _get(item.structures, structure_indices=structure_indices, check=False)
...
def get_box_angles_from_system(item, structure_indices='all', check=True):
    ...
    from molsysmt.tools.molsysmt_Structures import get_box_angles_from_system as _get
    return _get(item.structures, structure_indices=structure_indices, check=False)
...
def get_box_volume_from_system(item, structure_indices='all', check=True):
    ...
    from molsysmt.tools.molsysmt_Structures import get_box_volume_from_system as _get
    return _get(item.structures, structure_indices=structure_indices, check=False)
