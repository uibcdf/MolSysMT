...
def to_molsysmt_Structures(item, atom_indices='all', structure_indices='all', check=True):
    ...
    from molsysmt.tools.form.mmtf_MMTFDecoder.get import get_step_from_system, get_time_from_system
    from molsysmt.tools.form.mmtf_MMTFDecoder.get import get_coordinates_from_atom, get_box_from_system
