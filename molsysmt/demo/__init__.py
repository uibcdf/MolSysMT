...
demo['chicken villin HP35']['traj_explicit_solvent.dcd']= parent.joinpath('villin_HP35/traj_explicit_solvent.dcd').__str__()
demo['chicken villin HP35']['traj_explicit_solvent.h5']= parent.joinpath('villin_HP35/traj_explicit_solvent.h5').__str__()
