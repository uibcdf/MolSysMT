...
def to_mdtraj_Trajectory(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_molsysmt_MolSys import get_box_lengths_from_system
    from molsysmt.forms.api_molsysmt_MolSys import get_box_angles_from_system
    from molsysmt.forms.api_molsysmt_MolSys import get_coordinates_from_atom
    from molsysmt.forms.api_molsysmt_MolSys import get_time_from_system
