def from_openmm_PDBFile (item, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.native.io.composition.classes import from_openmm_PDBFile as molsysmt_composition_from_openmm_PDBFile
    from molsysmt.native.io.trajectory.classes import from_openmm_PDBFile as molsysmt_trajectory_from_openmm_PDBFile

    tmp_item = MolSys()
    tmp_item.composition = molsysmt_composition_from_openmm_PDBFile(item, atom_indices=atom_indices, frame_indices=frame_indices)
