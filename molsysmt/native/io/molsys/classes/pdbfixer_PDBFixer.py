def from_pdbfixer_PDBFixer (item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = MolSys()
    tmp_item.topology = pdbfixer_PDBFixer_to_molsysmt_Topology(item, atom_indices=atom_indices, frame_indices=frame_indices)
    tmp_item.trajectory = pdbfixer_PDBFixer_to_molsysmt_Trajectory(item, atom_indices=atom_indices, frame_indices=frame_indices)
...
def to_pdbfixer_PDBFixer (item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_pdb(item, output_filepath='.pdb', atom_indices=atom_indices, frame_indices=frame_indices)
