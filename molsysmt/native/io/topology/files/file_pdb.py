def to_file_pdb(item, molecular_system, atom_indices='all', frame_indices='all', output_filename=None):
    ...
    tmp_item, tmp_molecular_system =  openmm_Topology_to_file_pdb(tmp_item, tmp_molecular_system, output_filename=output_filename)
...
def from_file_pdb(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item, tmp_molecular_system = file_pdb_to_openmm_PDBFile(item, molecular_system)
