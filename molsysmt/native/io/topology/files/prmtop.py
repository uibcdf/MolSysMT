def from_prmtop(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.files.api_prmtop import to_openmm_Topology as prmtop_to_openmm_Topology
    from molsysmt.native.io.topology.classes import from_openmm_Topology as openmm_Topology_to_molsysmt_Topology

    tmp_item, tmp_molecular_system = prmtop_to_openmm_Topology(item, molecular_system)
