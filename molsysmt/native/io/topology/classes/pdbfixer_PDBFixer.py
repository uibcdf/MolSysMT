def from_pdbfixer_PDBFixer(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item, tmp_molecular_system = pdbfixer_PDBFixer_to_molsysmt_Topology(item, molecular_system)
...
def to_pdbfixer_PDBFixer(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item, tmp_molecular_system = openmm_Topology_to_pdbfixer_PDBFixer(tmp_item, tmp_molecular_system)
