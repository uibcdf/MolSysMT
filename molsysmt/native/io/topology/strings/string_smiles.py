def from_string_smiles (item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.strings.api_string_smiles import to_rdkit_Mol as string_smiles_to_rdkit_Mol
    from molsysmt.native.io.topology.classes.rdkit_Mol import from_rdkit_Mol as rdkit_Mol_to_molsysmt_Topology
