def to_string_pdb(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    tmp_item, tmp_molecular_system =  openmm_Topology_to_string_pdb(tmp_item, molecular_system=tmp_molecular_system)

    return tmp_item, tmp_molecular_system

def from_string_pdb(item, molecular_system=None, atom_indices='all', frame_indices='all'):
