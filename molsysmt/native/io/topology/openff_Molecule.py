def from_openff_Molecule(item, molecular_system=None, atom_indices='all', structure_indices='all'):

    from molsysmt.api_items.api_openff_Molecule import to_openmm_Topology as openff_Topology_to_openmm_Topology
