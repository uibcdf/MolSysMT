def from_pdbfixer_PDBFixer(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_pdbfixer_PDBFixer import to_openmm_Topology as pdbfixer_PDBFixer_to_molsysmt_Topology
...
def to_pdbfixer_PDBFixer(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_openmm_Topology import to_pdbfixer_PDBFixer as openmm_Topology_to_pdbfixer_PDBFixer
