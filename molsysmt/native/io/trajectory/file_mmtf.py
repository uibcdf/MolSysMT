def from_file_mmtf(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_file_mmtf import to_mmtf_MMTFDecoder as file_mmtf_to_mmtf_MMTFDecoder
    from molsysmt.native.io.trajectory import from_mmtf_MMTFDecoder as mmtf_MMTFDecoder_to_molsysmt_Trajectory
