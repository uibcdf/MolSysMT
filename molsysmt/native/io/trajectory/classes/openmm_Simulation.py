...
def from_openmm_Simulation(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item, tmp_molecular_system = openmm_Simulation_to_openmm_Context(item, molecular_system)
    tmp_item, tmp_molecular_system = openmm_Context_to_molsysmt_Trajectory(tmp_item, tmp_molecular_system, atom_indices=atom_indices)
