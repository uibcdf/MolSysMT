...
def from_openmm_Simulation(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from .openmm_Context import from_openmm_Context as openmm_Context_to_molsysmt_Structures
    ...
    tmp_item, tmp_molecular_system = openmm_Context_to_molsysmt_Structures(tmp_item,
