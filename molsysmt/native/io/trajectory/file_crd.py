...
def from_file_crd(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_mdanalysis_Universe import to_molsysmt_Trajectory as mdanalysis_Universe_to_molsysmt_Trajectory

    tmp_item, tmp_molecular_system = file_crd_to_mdanalysis_Universe(item, molecular_system=molecular_system)
    tmp_item, tmp_molecular_system = mdanalysis_Universe_to_molsysmt_Trajectory(tmp_item,
