...
def set_velocities_to_atom(item, indices='all', structure_indices='all', value=None, skip_digestion=False):
    ...
    if is_all(indices):
        n_atoms = molsysmt_TopologyOld_get_n_atoms_from_system(item.topology, skip_digestion=True)
        if n_atoms!=value.shape[1]:
            raise ValueError('Coordinates has a different atoms number.')
...
def set_structure_id_to_system(item, structure_indices='all', value=None, skip_digestion=False):
    ...
    return molsysmt_StructureOlds_set_structure_id_to_system(item.structures, structure_indices=structure_indices, value=value, skip_digestion=True)
...
def set_time_to_system(item, structure_indices='all', value=None, skip_digestion=False):
    ...
    return molsysmt_StructureOlds_set_time_to_system(item.structures, structure_indices=structure_indices, value=value, skip_digestion=True)
...
def set_box_to_system(item, structure_indices='all', value=None, skip_digestion=False):
    ...
    return molsysmt_StructureOlds_set_box_to_system(item.structures, structure_indices=structure_indices, value=value, skip_digestion=True)
...
def set_forcefield_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_forcefield_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_non_bonded_method_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_non_bonded_method_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_cutoff_distance_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_cutoff_distance_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_switch_distance_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_switch_distance_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_dispersion_correction_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_dispersion_correction_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_ewald_error_tolerance_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_ewald_error_tolerance_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_hydrogen_mass_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_hydrogen_mass_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_constraints_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_constraints_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_flexible_constraints_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_flexible_constraints_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_water_model_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_water_model_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_rigid_water_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_rigid_water_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_implicit_solvent_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_implicit_solvent_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_solute_dielectric_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_solute_dielectric_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_solvent_dielectric_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_solvent_dielectric_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_salt_concentration_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_salt_concentration_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
...
def set_kappa_to_system(item, value=None, skip_digestion=False):
    ...
    return molsysmt_MolecularMechanics_set_kappa_to_system(item.molecular_mechanics, value=value, skip_digestion=True)
