...
def get_atom_id_from_atom(item, indices='all', check=True):
    ...
    from ..openmm_GromacsGroFile import get_atom_id_from_atom as aux_get
...
def get_atom_name_from_atom(item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_atom_name_from_atom as aux_get
...
def get_atom_type_from_atom(item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_atom_type_from_atom as aux_get
...
def get_group_index_from_atom (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_group_index_from_atom as aux_get
...
def get_chain_index_from_atom (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_chain_index_from_atom as aux_get
...
def get_molecule_index_from_atom (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_molecule_index_from_atom as aux_get
...
def get_entity_index_from_atom (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_entity_index_from_atom as aux_get
...
def get_inner_bonded_atoms_from_atom (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_inner_bonded_atoms_from_atom as aux_get
...
def get_group_id_from_group(item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_group_id_from_group as aux_get
...
def get_group_name_from_group(item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_group_name_from_group as aux_get
...
def get_group_type_from_group(item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_group_type_from_group as aux_get
...
def get_component_id_from_component (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_component_id_from_component as aux_get
...
def get_component_name_from_component (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_component_name_from_component as aux_get
...
def get_component_type_from_component (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_component_type_from_component as aux_get
...
def get_molecule_id_from_molecule (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_molecule_id_from_molecule as aux_get
...
def get_molecule_name_from_molecule (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_molecule_name_from_molecule as aux_get
...
def get_molecule_type_from_molecule (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_molecule_type_from_molecule as aux_get
...
def get_chain_id_from_chain (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_chain_id_from_chain as aux_get
...
def get_chain_name_from_chain (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_chain_name_from_chain as aux_get
...
def get_chain_type_from_chain (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_chain_type_from_chain as aux_get
...
def get_entity_id_from_entity (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_entity_id_from_entity as aux_get
...
def get_entity_name_from_entity (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_entity_name_from_entity as aux_get
...
def get_entity_type_from_entity (item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_entity_type_from_entity as aux_get
...
def get_n_atoms_from_system(item, check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_n_atoms_from_system as aux_get
...
def get_n_groups_from_system(item, check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_n_groups_from_system as aux_get
...
def get_n_components_from_system(item, check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_n_components_from_system as aux_get
...
def get_n_chains_from_system(item, check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_n_chains_from_system as aux_get
...
def get_n_molecules_from_system(item, check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_n_molecules_from_system as aux_get
...
def get_n_entities_from_system(item, check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_n_entities_from_system as aux_get
...
def get_n_bonds_from_system(item, check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_n_bonds_from_system as aux_get
...
def get_box_from_system(item, structure_indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_box_from_system as aux_get
...
def get_time_from_system(item, structure_indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_time_from_system as aux_get
...
def get_step_from_system(item, structure_indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_step_from_system as aux_get
...
def get_n_structures_from_system(item, check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_n_structures_from_system as aux_get
...
def get_bonded_atoms_from_system(item, check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_bonded_atoms_from_system as aux_get
...
def get_bond_order_from_bond(item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_bond_order_from_bond as aux_get
...
def get_bond_type_from_bond(item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_bond_type_from_bond as aux_get
...
def get_atom_index_from_bond(item, indices='all', check=True):
    ...
    from . import to_openmm_GromacsGroFile
    from ..openmm_GromacsGroFile import get_atom_index_from_bond as aux_get
