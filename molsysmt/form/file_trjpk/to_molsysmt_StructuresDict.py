...
def to_molsysmt_StructuresDict(item, atom_indices='all', structure_indices='all'):
...
def _to_molsysmt_StructuresDict(item, molecular_system, atom_indices='all', structure_indices='all'):

    return to_molsysmt_StructuresDict(item, atom_indices=atom_indices, structure_indices=structure_indices)
