...
def get_atom_index_from_atom(item, indices='all', digest=True):
    ...
    return aux_get(item.topology, indices=indices, digest=False)
...
def get_coordinates_from_atom(item, indices='all', structure_indices='all', digest=True):
    ...
    return aux_get(item.structures, indices=indices, structure_indices=structure_indices, digest=False)
...
def get_n_atoms_from_system(item, digest=True):
    ...
    return aux_get(item.topology, digest=False)
...
def get_coordinates_from_system(item, structure_indices='all', digest=True):
    ...
    return aux_get(item.structures, structure_indices=structure_indices, digest=False)
...
def get_n_structures_from_system(item, digest=True):
    ...
    return aux_get(item.structures, digest=False)
