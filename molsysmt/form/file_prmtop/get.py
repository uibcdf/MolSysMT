...
def get_box_from_system(item, structure_indices='all', check=True):
    ...
    tmp_item = to_openmm_AmberPrmtopFile(item, structure_indices=structure_indices, check=False)
    output = aux_get(tmp_item, check=False)
...
def get_box_shape_from_system(item, structure_indices='all', check=True):
    ...
    from . import to_openmm_AmberPrmtopFile
    from ..openmm_AmberPrmtopFile import get_box_shape_from_system as aux_get
...
def get_box_lengths_from_system(item, structure_indices='all', check=True):
    ...
    from . import to_openmm_AmberPrmtopFile
    from ..openmm_AmberPrmtopFile import get_box_lengths_from_system as aux_get
...
def get_box_angles_from_system(item, structure_indices='all', check=True):
    ...
    from . import to_openmm_AmberPrmtopFile
    from ..openmm_AmberPrmtopFile import get_box_angles_from_system as aux_get
...
def get_box_volume_from_system(item, structure_indices='all', check=True):
    ...
    from . import to_openmm_AmberPrmtopFile
    from ..openmm_AmberPrmtopFile import get_box_volume_from_system as aux_get
...
def get_bonded_atoms_from_system(item, check=True):
    ...
    from . import to_openmm_AmberPrmtopFile
    from ..openmm_AmberPrmtopFile import get_bonded_atoms_from_system as aux_get
