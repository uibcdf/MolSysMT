...
def get_bonded_atoms_from_system(item, check=True):
    ...
    from . import to_molsysmt_Topology
    from ..molsysmt_Structures import get_bonded_atoms_from_system as aux_get
...
def get_bond_order_from_bond(item, indices='all', check=True):
    ...
    from . import to_molsysmt_Topology
    from ..molsysmt_Structures import get_bond_order_from_bond as aux_get
...
def get_bond_type_from_bond(item, indices='all', check=True):
    ...
    from . import to_molsysmt_Topology
    from ..molsysmt_Structures import get_bond_type_from_bond as aux_get
...
def get_atom_index_from_bond(item, indices='all', check=True):
    ...
    from . import to_molsysmt_Topology
    from ..molsysmt_Structures import get_atom_index_from_bond as aux_get
