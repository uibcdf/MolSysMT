...
def get_component_id_from_component(item, indices='all', digest=True):
    ...
    output = get_component_id_from_component(item, indices=indices, digest=False)
...
def get_component_name_from_component(item, indices='all', digest=True):
    ...
    output = get_component_name_from_component(item, indices=indices, digest=False)
...
def get_component_type_from_component(item, indices='all', digest=True):
    ...
    output = get_component_type_from_component(item, indices=indices, digest=False)
...
def get_molecule_id_from_molecule(item, indices='all', digest=True):
    ...
    output = get_molecule_id_from_molecule(item, indices=indices, digest=False)
...
def get_molecule_name_from_molecule(item, indices='all', digest=True):
    ...
    output = get_molecule_name_from_molecule(item, indices=indices, digest=False)
...
def get_molecule_type_from_molecule(item, indices='all', digest=True):
    ...
    output = get_molecule_type_from_molecule(item, indices=indices, digest=False)
...
def get_entity_id_from_entity(item, indices='all', digest=True):
    ...
    output = get_entity_id_from_entity(item, indices=indices, digest=False)
...
def get_entity_name_from_entity(item, indices='all', digest=True):
    ...
    output = get_entity_name_from_entity(item, indices=indices, digest=False)
...
def get_entity_type_from_entity(item, indices='all', digest=True):
    ...
    output = get_entity_type_from_entity(item, indices=indices, digest=False)
