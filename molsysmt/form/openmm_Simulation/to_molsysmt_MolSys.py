...
def to_molsysmt_MolSys(item, atom_indices='all', structure_indices='all', digest=True):
    ...
    tmp_item = MolSys()
    tmp_item.topology = openmm_Simulation_to_molsysmt_Topology(item, atom_indices=atom_indices, digest=False)
    tmp_item.trajectory = openmm_Simulation_to_molsysmt_Structures(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
