...
def get_n_aminoacids_from_atom(item, indices='all', skip_digestion=False):
    ...
    bonds_required = bonds_are_required_to_get_attribute('n_aminoacids', 'atom')
    tmp_item = to_molsysmt_Topology(item, get_missing_bonds=bonds_required, skip_digestion=True)
    output = aux_get(tmp_item, indices=indices, skip_digestion=True)
...
def get_n_aminoacids_from_component(item, indices='all', skip_digestion=False):
    ...
    bonds_required = bonds_are_required_to_get_attribute('n_aminoacids', 'component')
    tmp_item = to_molsysmt_Topology(item, get_missing_bonds=bonds_required, skip_digestion=True)
    output = aux_get(tmp_item, indices=indices, skip_digestion=True)
...
def get_n_aminoacids_from_chain(item, indices='all', skip_digestion=False):
    ...
    bonds_required = bonds_are_required_to_get_attribute('n_aminoacids', 'chain')
    tmp_item = to_molsysmt_Topology(item, get_missing_bonds=bonds_required, skip_digestion=True)
    output = aux_get(tmp_item, indices=indices, skip_digestion=True)
...
def get_n_aminoacids_from_entity(item, indices='all', skip_digestion=False):
    ...
    bonds_required = bonds_are_required_to_get_attribute('n_aminoacids', 'entity')
    tmp_item = to_molsysmt_Topology(item, get_missing_bonds=bonds_required, skip_digestion=True)
    output = aux_get(tmp_item, indices=indices, skip_digestion=True)
...
def get_n_aminoacids_from_system(item, skip_digestion=False):
    ...
    bonds_required = bonds_are_required_to_get_attribute('n_aminoacids', 'system')
    tmp_item = to_molsysmt_Topology(item, get_missing_bonds=bonds_required, skip_digestion=True)
    output = aux_get(tmp_item, skip_digestion=True)
