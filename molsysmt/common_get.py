...
def get_bond_index_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.basic import get
    return get(item, indices='all', target='atoms', bond_index=True)

def get_inner_bonded_atoms_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.basic import get
    return get(item, indices='all', target='bond', atom_index=True)

def get_inner_bond_index_from_system(item, indices='all', structure_indices='all'):
