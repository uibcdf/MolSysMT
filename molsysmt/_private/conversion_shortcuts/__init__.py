...
from .to_molsysmt_MolSys import molsysmt_Topology_and_molsysmt_StructuresDict_to_molsysmt_MolSys
...
from .to_molsysmt_MolSys import openmm_Topology_and_molsysmt_StructuresDict_to_molsysmt_MolSys

from .to_molsysmt_Topology import molsysmt_Topology_and_molsysmt_Structures_to_molsysmt_Topology
from .to_molsysmt_Topology import molsysmt_Topology_and_molsysmt_StructuresDict_to_molsysmt_Topology
...
from .to_molsysmt_Topology import openmm_Topology_and_molsysmt_StructuresDict_to_molsysmt_Topology


_multiple_conversion_shortcuts[tuple(sorted(('molsysmt.Topology','molsysmt.StructuresDict')))]={
        'molsysmt.MolSys': molsysmt_Topology_and_molsysmt_StructuresDict_to_molsysmt_MolSys,
        'molsysmt.Topology': molsysmt_Topology_and_molsysmt_StructuresDict_to_molsysmt_Topology
        }
...
_multiple_conversion_shortcuts[tuple(sorted(('openmm.Topology','molsysmt.StructuresDict')))]={
        'molsysmt.MolSys': openmm_Topology_and_molsysmt_StructuresDict_to_molsysmt_MolSys,
        'molsysmt.Topology': openmm_Topology_and_molsysmt_StructuresDict_to_molsysmt_Topology
        }
