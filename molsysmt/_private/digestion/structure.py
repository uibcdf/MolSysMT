import numpy as np
from ..exceptions.structure import WrongStructureIndicesError
from ..exceptions.variables import is_all
...
def digest_structure_indices(structure_indices, caller=None):
    ...
    if structure_indices is None:
        ...
        raise WrongStructureIndicesError(structure_indices, caller=caller)
