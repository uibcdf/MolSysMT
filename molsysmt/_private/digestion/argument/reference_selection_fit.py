...
def digest_reference_selection_fit(reference_selection_fit, syntax="MolSysMT", caller=None):
    ...
    return digest_selection(reference_selection_fit, syntax=syntax, caller=caller)
