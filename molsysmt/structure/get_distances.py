    ...
    if engine=='MolSysMT':
        ...
        if selection is not None:
            ...
            if group_behavior == 'center_of_mass':
                ...
                coordinates_1 = get(molecular_system, element='atom', indices=atom_indices_1, structure_indices=structure_indices, coordinates=True)
        else:
        ...
        if selection_2 is not None:
            ...
            if same_system and same_selection and same_frames:
                ...
                if group_behavior_2 == 'center_of_mass':
                    ...
                    coordinates_2 = get(molecular_system_2, element='atom', indices=atom_indices_2, structure_indices=structure_indices_2, coordinates=True)
