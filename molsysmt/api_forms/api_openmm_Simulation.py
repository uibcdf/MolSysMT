...
def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return openmm_Simulation_to_molsysmt_Topology(item, atom_indices=atom_indices, check=False)
...
def to_openmm_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return openmm_Simulation_to_openmm_Topology(item, atom_indices=atom_indices, check=False)
