...
def to_mmtf_MMTFDecoder(item, molecular_system=None, atom_indices='all', structure_indices='all'):

    from mmtf import parse
    from molsysmt.api_forms.api_mmtf_MMTFDecoder import to_mmtf_MMTFDecoder as mmtf_MMTFDecoder_to_mmtf_MMTFDecoder
...
def to_molsysmt_MolSys(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_mmtf_MMTFDecoder import to_molsysmt_MolSys as mmtf_MMTFDecoder_to_molsysmt_MolSys

    tmp_item, tmp_molecular_system = to_mmtf_MMTFDecoder(item, molecular_system=molecular_system, atom_indices='all', structure_indices='all')
...
def to_molsysmt_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_mmtf_MMTFDecoder import to_molsysmt_Topology as mmtf_MMTFDecoder_to_molsysmt_Topology
...
def to_molsysmt_Structures(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_mmtf_MMTFDecoder import to_molsysmt_Structures as mmtf_MMTFDecoder_to_molsysmt_Structures
...
def to_string_aminoacids1(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import to_string_aminoacids1 as molsysmt_Topology_to_string_aminoacids1

    tmp_item, tmp_molecular_system = to_molsysmt_Topology(item, molecular_system=molecular_system, atom_indices=atom_indices, structure_indices=structure_indices)
...
def to_mdanalysis_Universe(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    if molecular_system is not None:
        ...
        tmp_molecular_system = None
    tmp_item, tmp_molecular_system = mdanalysis_Universe_to_mdanalysis_Universe(tmp_item, molecular_system=molecular_system, atom_indices=atom_indices, structure_indices=structure_indices, copy_if_all=False)

    return tmp_item, tmp_molecular_system

def to_file_pdb(item, molecular_system=None, atom_indices='all', structure_indices='all', output_filename=None):

    from molsysmt.api_forms.api_mmtf_MMTFDecoder import to_pdb as mmtf_MMTFDecoder_to_pdb

    tmp_item, tmp_molecular_system = to_mmtf_MMTFDecoder(item, molecular_system=molecular_system, atom_indices=atom_indices, structure_indices=structure_indices)
...
def to_file_mmtf(item, molecular_system=None, atom_indices='all', structure_indices='all', output_filename=None, copy_if_all=False):
...
def aux_get(item, indices='all', structure_indices='all'):
    ...
    if 'mmtf.MMTFDecoder' in forms:
        ...
        module = importlib.import_module('molsysmt.api_forms.api_mmtf_MMTFDecoder')
