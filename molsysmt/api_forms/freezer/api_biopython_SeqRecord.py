...
def to_file_pir(item, molecular_system=None, atom_indices='all', structure_indices='all', output_filename=None, style=None):

    from Bio.SeqIO.PirIO import PirWriter as PirWriter
    from molsysmt.api_forms.api_file_pir import rewrite_to_style as rewrite
