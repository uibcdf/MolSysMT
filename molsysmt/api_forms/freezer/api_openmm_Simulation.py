...
def to_molsysmt_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.native.io.topology import from_openmm_Simulation as openmm_Simulation_to_molsysmt_Topology
...
def to_molsysmt_Structures(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.native.io.trajectory import from_openmm_Simulation as openmm_Simulation_to_molsysmt_Structures

    tmp_item, tmp_molecular_system = openmm_Simulation_to_molsysmt_Structures(item,
            molecular_system=molecular_system, atom_indices=atom_indices, structure_indices=structure_indices)
...
def to_molsysmt_MolSys(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.native.io.molsys import from_openmm_Simulation as openmm_Simulation_to_molsysmt_MolSys
...
def to_openmm_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_openmm_Topology import openmm_Topology_to_openmm_Topology
    ...
    tmp_item, tmp_molecular_system = openmm_Topology_to_openmm_Topology(tmp_item, molecular_system, atom_indices=atom_indices, structure_indices=structure_indices, copy_with_all=False)
...
def to_openmm_Modeller(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    topology, _ = to_openmm_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices)
...
def to_file_pdb(item, molecular_system=None, atom_indices='all', structure_indices='all', output_filename=None):
    ...
    from molsysmt.api_forms.api_openmm_Topology import to_file_pdb as openmm_Topology_to_file_pdb
...
def to_openmm_Simulation(item, molecular_system=None, atom_indices='all', structure_indices='all', copy_if_all=True):
