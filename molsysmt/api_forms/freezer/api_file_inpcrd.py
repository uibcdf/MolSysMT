...
def to_molsysmt_Structures(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.native.io.trajectory import from_file_inpcrd as file_inpcrd_to_molsysmt_Structures

    tmp_item, tmp_molecular_system = file_inpcrd_to_molsysmt_Structures(item, molecular_system=molecular_system, atom_indices=atom_indices, structure_indices=structure_indices)
