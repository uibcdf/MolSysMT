...
def to_file_msmpk(item, molecular_system=None, atom_indices='all', structure_indices='all', output_filename=None, copy_if_all=False):
...
def aux_get(item, indices='all', structure_indices='all'):
    ...
    module = importlib.import_module('molsysmt.api_forms.api_molsysmt_MolSys')
