...
def to_molsysmt_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    tmp_item, tmp_molecular_system = nglview_NGLWidget_to_molsysmt_Topology(item, molecular_system=molecular_system, atom_indices=atom_indices, structure_indices='all')
...
def to_openmm_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_string_pdb_text import to_openmm_Topology as string_pdb_to_openmm_Topology
...
def to_string_aminoacids1(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_MolSys import to_string_aminoacids1 as molsysmt_MolSys_to_string_aminoacids1
...
def to_nglview_NGLWidget(item, molecular_system=None, atom_indices='all', structure_indices='all', copy_if_all=True):
...
def merge(item_1, item_2):
    ...
    from molsysmt.api_forms.api_molsysmt_MolSys import to_nglview_NGLWidget as molsysmt_MolSys_to_nglview_NGLWidget
    from molsysmt.api_forms.api_molsysmt_MolSys import merge as merge_molsysmt_MolSys
...
def aux_get(item, indices='all', structure_indices='all'):
    ...
    if 'openmm.Topology' in forms:
        ...
        tmp_item, _ = to_openmm_Topology(item, structure_indices=structure_indices)
