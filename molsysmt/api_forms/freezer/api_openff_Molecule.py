...
def to_molsysmt_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.native.io.topology import from_openff_Molecule as openff_Molecule_to_molsysmt_Topology
...
def to_molsysmt_MolSys(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.native.io.topology import from_openff_Molecule as openff_Molecule_to_molsysmt_MolSys
...
def to_openff_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
...
def to_openff_Molecule(item, molecular_system=None, atom_indices='all', structure_indices='all', copy_if_all=True):
