...
def to_string_aminoacids3(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_mdtraj_Topology import to_string_aminoacids3 as mdtraj_Topology_to_string_aminoacids3
...
def to_string_aminoacids1(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_mdtraj_Topology import to_string_aminoacids1 as mdtraj_Topology_to_string_aminoacids1
...
def to_biopython_Seq(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    tmp_item, tmp_molecular_system = to_string_aminoacids1(item, molecular_system=molecular_system, atom_indices=atom_indices, structure_indices=structure_indices)
...
def to_molsysmt_MolSys(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.native.io.molsys import from_mdtraj_Trajectory as mdtraj_Trajectory_to_molsysmt_MolSys

    tmp_item, tmp_molecular_system = mdtraj_Trajectory_to_molsysmt_MolSys(item, molecular_system=molecular_system, atom_indices=atom_indices, structure_indices=structure_indices)

    return tmp_item, tmp_molecular_system

def to_molsysmt_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):

    from molsysmt.native.io.trajectory import from_mdtraj_Trajectory as mdtraj_Trajectory_to_molsysmt_Topology

    tmp_item, tmp_molecular_system = mdtraj_Trajectory_to_molsysmt_Topology(item, molecular_system=molecular_system, atom_indices=atom_indices, structure_indices=structure_indices)

    return tmp_item, tmp_molecular_system

def to_molsysmt_Trajectory(item, molecular_system=None, atom_indices='all', structure_indices='all'):

    from molsysmt.native.io.topology import from_mdtraj_Trajectory as mdtraj_Trajectory_to_molsysmt_Topology
...
def to_openmm_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    tmp_item, tmp_molecular_system = to_mdtraj_Topology(item, molecular_system, atom_indices=atom_indices, structure_indices=structure_indices)
...
def to_openmm_Modeller(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    topology, _ = to_openmm_Topology(item, molecular_system=None, atom_indices=atom_indices, structure_indices=structure_indices)
...
def to_pdbfixer_PDBFixer(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    tmp_item, tmp_molecular_system = to_pdb(item, molecular_system=molecular_system, output_filename=tmp_file, atom_indices=atom_indices, structure_indices=structure_indices)
...
def to_file_pdb(item, molecular_system=None, atom_indices='all', structure_indices='all', output_filename=None):
    ...
    tmp_item, tmp_molecular_system = to_mdtraj_Trajectory(item, molecular_system=molecular_system, atom_indices=atom_indices, structure_indices=structure_indices, copy_if_all=False)
...
def to_file_xtc(item, molecular_system=None, atom_indices='all', structure_indices='all', output_filename=None):
...
def to_mdtraj_Trajectory(item, molecular_system=None, atom_indices='all', structure_indices='all', copy_if_all=True):
