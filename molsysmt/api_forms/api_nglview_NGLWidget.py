...
def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return nglview_NGLWidget_to_molsysmt_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_molsysmt_MolSys(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return nglview_NGLWidget_to_molsysmt_MolSys(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_openmm_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    return nglview_NGLWidget_to_openmm_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_string_pdb_text(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return nglview_NGLWidget_to_string_pdb_text(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_string_aminoacids1(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return nglview_NGLWidget_to_aminoacids1(item, atom_indices=atom_indices, digest=False)
...
def to_string_aminoacids3(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return nglview_NGLWidget_to_aminoacids3(item, atom_indices=atom_indices, digest=False)
