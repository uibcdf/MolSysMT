...
def to_openmm_System(item, molecular_system=None, atom_indices='all', frame_indices='all',
    ...
    from molsysmt.forms.api_openmm_Modeller import to_openmm_System as openmm_Modeller_to_openmm_System
...
def to_openmm_Simulation(item, molecular_system=None, atom_indices='all', frame_indices='all',
    ...
    from molsysmt.forms.api_openmm_Modeller import to_openmm_Simulation as openmm_Modeller_to_openmm_Simulation
...
def to_nglview_NGLWidget(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    tmp_item, tmp_molecular_system = to_string_pdb_text(item, molecular_system=molecular_system, atom_indices=atom_indices, frame_indices=frame_indices, copy_if_all=False)
...
def to_string_pdb_text(item, molecular_system=None, atom_indices='all', frame_indices='all', copy_if_all=True):
