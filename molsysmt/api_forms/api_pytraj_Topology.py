...
from molsysmt.form.pytraj_Topology.iterators import StructuresIterator, TopologyIterator
...
def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return pytraj_Topology_to_molsysmt_Topology(item, atom_indices=atom_indices, digest=False)
