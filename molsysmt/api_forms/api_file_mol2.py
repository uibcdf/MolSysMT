...
from molsysmt.form.file_mol2.iterators import StructuresIterator, TopologyIterator
...
def to_molsysmt_MolSys(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mol2_to_molsysmt_MolSys(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)


def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    from molsysmt.form.file_mol2 import to_molsysmt_Topology as file_mol2_to_molsysmt_Topology

    return file_mol2_to_molsysmt_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)


def to_molsysmt_Structures(item, molecular_system, atom_indices='all', structure_indices='all'):
    from molsysmt.form.file_mol2 import to_molsysmt_Structures as file_mol2_to_molsysmt_Structures

    return file_mol2_to_molsysmt_Structures(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_parmed_Structure(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mol2_to_parmed_Structure(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_mdtraj_Trajectory(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mol2_to_mdtraj_Trajectory(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)


def to_mdtraj_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    from molsysmt.form.file_mol2 import to_mdtraj_Topology as file_mol2_to_mdtraj_Topology

    return file_mol2_to_mdtraj_Topology(item, atom_indices=atom_indices, digest=False)


def to_openmm_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    from molsysmt.form.file_mol2 import to_openmm_Topology as file_mol2_to_openmm_Topology

    return file_mol2_to_openmm_Topology(item, atom_indices=atom_indices, digest=False)
