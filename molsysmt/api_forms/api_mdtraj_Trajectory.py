...
from molsysmt.form.mdtraj_Trajectory.add import add
from molsysmt.form.mdtraj_Trajectory.append_structures import append_structures
from molsysmt.form.mdtraj_Trajectory.get import *
from molsysmt.form.mdtraj_Trajectory.set import *
from molsysmt.form.mdtraj_Trajectory.iterators import StructuresIterator, TopologyIterator
...
def to_string_aminoacids3(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return mdtraj_Trajectory_to_string_aminoacids3(item, group_indices=group_indices, digest=False)
...
def to_string_aminoacids1(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    group_indices = get_group_index_from_atom(item, indices=atom_indices, digest=False)
    group_indices = np.unique(group_indices)
    return mdtraj_Trajectory_to_string_aminoacids1(item, group_indices=group_indices, digest=False)
...
def to_biopython_Seq(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    group_indices = get_group_index_from_atom(item, indices=atom_indices, digest=False)
    group_indices = np.unique(group_indices)
    return mdtraj_Trajectory_to_biopython_Seq(item, group_indices=group_indices, digest=False)
...
def to_biopython_SeqRecord(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    group_indices = get_group_index_from_atom(item, indices=atom_indices, digest=False)
    group_indices = np.unique(group_indices)
    return mdtraj_Trajectory_to_biopython_SeqRecord(item, group_indices=group_indices, digest=False)


def to_molsysmt_MolSys(item, molecular_system, atom_indices='all', structure_indices='all'):
    from molsysmt.form.mdtraj_Trajectory import to_molsysmt_MolSys as mdtraj_Trajectory_to_molsysmt_MolSys

    return mdtraj_Trajectory_to_molsysmt_MolSys(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return mdtraj_Trajectory_to_molsysmt_Topology(item, atom_indices=atom_indices, digest=False)
...
def to_mdtraj_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return mdtraj_Trajectory_to_mdtraj_Topology(item, atom_indices=atom_indices, digest=False)


def to_openmm_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    from molsysmt.form.mdtraj_Trajectory import to_openmm_Topology as mdtraj_Trajectory_to_openmm_Topology

    return mdtraj_Trajectory_to_openmm_Topology(item, atom_indices=atom_indices, digest=False)
...
def to_pytraj_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return mdtraj_Trajectory_to_pytraj_Topology(item, atom_indices=atom_indices, digest=False)
...
def to_pdbfixer_PDBFixer(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return mdtraj_Trajectory_to_pdbfixer_PDBFixer(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
