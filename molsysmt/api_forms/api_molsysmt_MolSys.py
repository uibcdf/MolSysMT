...
def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_molsysmt_Topology(item, atom_indices=atom_indices, digest=False)
...
def to_molsysmt_Structures(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_molsysmt_Structures(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_XYZ(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_XYZ(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_string_aminoacids3(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_string_aminoacids3(item, group_indices=group_indices, digest=False)
...
def to_string_aminoacids1(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    group_indices = get_group_index_from_atom(item, indices=atom_indices, digest=False)
    group_indices = np.unique(group_indices)
    return molsysmt_MolSys_to_string_aminoacids1(item, group_indices=group_indices, digest=False)
...
def to_biopython_Seq(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    group_indices = get_group_index_from_atom(item, indices=atom_indices, digest=False)
    group_indices = np.unique(group_indices)
    return molsysmt_MolSys_to_biopython_Seq(item, group_indices=group_indices, digest=False)
...
def to_biopython_SeqRecord(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    group_indices = get_group_index_from_atom_molsysmt_MolSys(item, indices=atom_indices, digest=False)
    group_indices = np.unique(group_indices)
    return molsysmt_MolSys_to_biopython_SeqRecord(item, group_indices=group_indices, digest=False)
...
def to_mdtraj_Trajectory(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_mdtraj_Trajectory(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)


def to_mdtraj_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    from molsysmt.form.molsysmt_MolSys import to_mdtraj_Topology as molsysmt_MolSys_to_mdtraj_Topology

    return molsysmt_MolSys_to_mdtraj_Topology(item, atom_indices=atom_indices, digest=False)


def to_openmm_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    from molsysmt.form.molsysmt_MolSys import to_openmm_Topology as molsysmt_MolSys_to_openmm_Topology

    return molsysmt_MolSys_to_openmm_Topology(item, atom_indices=atom_indices, digest=False)
...
def to_openmm_Modeller(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_openmm_Modeller(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_openmm_System(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_openmm_System(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_openmm_Context(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_openmm_Context(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_openmm_Simulation(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_openmm_Simulation(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_string_pdb_text(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_string_pdb_text(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_pdbfixer_PDBFixer(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_pdbfixer_PDBFixer(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_pytraj_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_pytraj_Topology(item, atom_indices=atom_indices, digest=False)
...
def to_pytraj_Trajectory(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_pytraj_Trajectory(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_nglview_NGLWidget(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolSys_to_nglview_NGLWidget(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
