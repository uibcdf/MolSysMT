...
def to_molsysmt_Trajectory(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_molsysmt_Trajectory(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
...
def to_XYZ(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_XYZ(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
...
def to_mdtraj_Trajectory(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_mdtraj_Trajectory(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
...
def to_openmm_Modeller(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_openmm_Modeller(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
...
def to_openmm_System(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_openmm_System(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
...
def to_openmm_Context(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_openmm_Context(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
...
def to_openmm_Simulation(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_openmm_Simulation(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
...
def to_file_pdb(item, molecular_system, atom_indices='all', frame_indices='all', output_filename=None):
    ...
    tmp_item = molsysmt_MolSys_to_file_pdb(item, atom_indices=atom_indices, frame_indices=frame_indices, output_filename=output_filename, check_form=False)
...
def to_file_msmpk(item, molecular_system, atom_indices='all', frame_indices='all', output_filename=None):
    ...
    tmp_item = molsysmt_MolSys_to_file_msmpk(item, atom_indices=atom_indices, frame_indices=frame_indices, output_filename=output_filename, check_form=False)
...
def to_string_pdb_text(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_string_pdb_text(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
...
def to_pdbfixer_PDBFixer(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_pdbfixer_PDBFixer(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
...
def to_nglview_NGLWidget(item, molecular_system, atom_indices='all', frame_indices='all'):
    ...
    tmp_item = molsysmt_MolSys_to_nglview_NGLWidget(item, atom_indices=atom_indices, frame_indices=frame_indices, check_form=False)
