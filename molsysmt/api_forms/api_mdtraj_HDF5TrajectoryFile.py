...
def to_mdtraj_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return mdtraj_HDF5TrajectoryFile_to_mdtraj_Topology(item, atom_indices=atom_indices, digest=False)
...
def to_openmm_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return mdtraj_HDF5TrajectoryFile_to_openmm_Topology(item, atom_indices=atom_indices, digest=False)
