...
def to_mmtf_MMTFDecoder(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mmtf_to_mmtf_MMTFDecoder(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_molsysmt_MolSys(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mmtf_to_molsysmt_MolSys(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mmtf_to_molsysmt_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_molsysmt_Structures(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mmtf_to_molsysmt_Structures(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_openmm_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mmtf_to_openmm_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
...
def to_string_aminoacids1(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mmtf_to_string_aminoacids1(item, group_indices=group_indices, digest=False)
...
def to_string_aminoacids3(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mmtf_to_string_aminoacids3(item, group_indices=group_indices, digest=False)
...
def to_mdanalysis_Universe(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return file_mmtf_to_mdanalysis_Universe(item, atom_indices=atom_indices, structure_indices=structure_indices, digest=False)
