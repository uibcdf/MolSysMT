...
def to_string_aminoacids1(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    return string_aminoacids3_to_string_aminoacids1(item, atom_indices=atom_indices, digest=False)
...
def to_biopython_Seq(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return string_aminoacids3_to_biopython_Seq(item, atom_indices=atom_indices, digest=False)
...
def to_biopython_SeqRecord(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return string_aminoacids3_to_biopython_SeqRecord(item, atom_indices=atom_indices, digest=False)
