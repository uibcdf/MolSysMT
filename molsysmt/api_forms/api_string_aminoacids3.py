...
from molsysmt.tools.string_aminoacids3.is_string_aminoacids3 import is_string_aminoacids3 as is_form
from molsysmt.tools.string_aminoacids3.extract import extract
from molsysmt.tools.string_aminoacids3.add import add
from molsysmt.tools.string_aminoacids3.merge import merge
from molsysmt.tools.string_aminoacids3.append_structures import append_structures
from molsysmt.tools.string_aminoacids3.concatenate_structures import concatenate_structures
from molsysmt.tools.string_aminoacids3.get import *
from molsysmt.tools.string_aminoacids3.set import *
...
def to_biopython_Seq(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.tools.string_aminoacids3 import to_biopython_Seq as string_aminoacids3_to_biopython_Seq
...
def to_biopython_SeqRecord(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.tools.string_aminoacids3 import to_biopython_SeqRecord as string_aminoacids3_to_biopython_SeqRecord
