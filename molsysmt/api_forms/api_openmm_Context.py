...
def to_openmm_System(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return openmm_Context_to_openmm_System(item, atom_indices=atom_indices, digest=False)
...
def to_molsysmt_Structures(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return openmm_Context_to_molsysmt_Structures(item, atom_indices=atom_indices, digest=False)
