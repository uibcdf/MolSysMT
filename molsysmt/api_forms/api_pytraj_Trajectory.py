...
def to_pytraj_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return pytraj_Trajectory_to_pytraj_Topology(item, atom_indices=atom_indices, digest=False)
...
def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return pytraj_Trajectory_to_molsysmt_Topology(item, atom_indices=atom_indices, digest=False)
