...
from molsysmt.form.molsysmt_MolecularMechanics.iterators import StructuresIterator, TopologyIterator
...
def to_MolecularMechanicsDict(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return molsysmt_MolecularMechanics_to_molsysmt_MolecularMechanicsDict(item, digest=False)
