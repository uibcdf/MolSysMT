...
def to_openmm_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return openmm_GromacsGroFile_to_openmm_Topology(item, atom_indices=atom_indices, check=False)
...
def to_openmm_Modeller(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return openmm_GromacsGroFile_to_openmm_Modeller(item, atom_indices=atom_indices, check=False)
...
def to_molsysmt_MolSys(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return openmm_GromacsGroFile_to_molsysmt_MolSys(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return openmm_GromacsGroFile_to_molsysmt_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_molsysmt_Structures(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return openmm_GromacsGroFile_to_molsysmt_Structures(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
