...
from molsysmt.form.openmm_GromacsGroFile.iterators import StructuresIterator, TopologyIterator
...
def to_openmm_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return openmm_GromacsGroFile_to_openmm_Topology(item, atom_indices=atom_indices, digest=False)
...
def to_openmm_Modeller(item, molecular_system, atom_indices='all', structure_indices='all'):
    ...
    return openmm_GromacsGroFile_to_openmm_Modeller(item, atom_indices=atom_indices, digest=False)
