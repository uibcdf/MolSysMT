...
def to_string_aminoacids3(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_string_aminoacids3(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_string_aminoacids1(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_string_aminoacids1(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_biopython_Seq(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_biopython_Seq(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_biopython_SeqRecord(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_biopython_SeqRecord(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_mdtraj_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_mdtraj_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_mdtraj_Trajectory(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_mdtraj_Trajectory(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_openmm_Modeller(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_openmm_Modeller(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_openmm_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_openmm_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices, check=False)
...
def to_molsysmt_Topology(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_molsysmt_Topology(item, atom_indices=atom_indices, check=False)
...
def to_molsysmt_MolSys(item, molecular_system, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_molsysmt_MolSys(item, atom_indices=atom_indices, check=False)
...
def to_parmed_Structure(item, molecular_system=None, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_parmed_Structure(item, atom_indices=atom_indices, check=False)
...
def to_file_pdb(item, molecular_system=None, atom_indices='all', structure_indices='all', output_filename=None):
	...
	return pdbfixer_PDBFixer_to_file_pdb(item, atom_indices=atom_indices, check=False)
...
def to_nglview_NGLWidget(item, molecular_system=None, atom_indices='all', structure_indices='all'):
	...
	return pdbfixer_PDBFixer_to_nglview_NGLWidget(item, atom_indices=atom_indices, check=False)
