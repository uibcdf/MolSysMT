...
def compare_n_molecules_eq(molecular_system_A, molecular_system_B, selection_A='all',
    ...
    n_rnas_A, n_lipids_A, n_oligosaccharides_A = get(molecular_system_A, element='system', selection=selection_A,
                               structure_indices=structure_indices_A, n_ions=True, n_waters=True,
    ...
    n_rnas_B, n_lipids_B, n_oligosaccharides_B = get(molecular_system_A, element='system', selection=selection_B,
                               structure_indices=structure_indices_B, n_ions=True, n_waters=True,
                               n_small_molecules=True, n_peptides=True, n_proteins=True, n_dnas=True, n_rnas=True,
                               n_lipids=True, n_oligosaccharides=True)
