...
def compare_info_no_form_eq(molecular_system_A, molecular_system_B, selection_A='all',
    ...
    n_ions_A, n_waters_A, n_small_molecules_A, n_peptides_A, n_proteins_A, n_dnas_A,\
    n_rnas_A, n_lipids_A, n_oligosaccharides_A = get(molecular_system_A, element='system', selection=selection_A,
                               structure_indices=structure_indices_A, syntax=syntax, n_atoms=True, n_groups=True,
                               ...
                               n_oligosaccharides=True)

    n_atoms_B, n_groups_B, n_components_B, n_chains_B, n_molecules_B, n_entities_B, n_structures_B,\
    n_ions_B, n_waters_B, n_small_molecules_B, n_peptides_B, n_proteins_B, n_dnas_B,\
    n_rnas_B, n_lipids_B, n_oligosaccharides_B = get(molecular_system_B, element='system', selection=selection_B,
                               structure_indices=structure_indices_B, syntax=syntax, n_atoms=True, n_groups=True,
                               n_components=True, n_chains=True, n_molecules=True, n_entities=True, n_structures=True,
                               n_ions=True, n_waters=True, n_small_molecules=True, n_peptides=True,
                               n_proteins=True, n_dnas=True, n_rnas=True, n_lipids=True,
                               n_oligosaccharides=True)
    ...
    report['n_oligosaccharides']=(n_oligosaccharides_A==n_oligosaccharides_B)
