...
def has_attribute(molecular_system, attribute):
    ...
    from molsysmt.attribute.attributes import topological_attributes, structural_attributes,\
            dynamical_attributes, mechanical_attributes
    ...
    elif attribute == 'dynamical':

        for form_in in forms_in:
            for dynamical_attribute in dynamical_attributes:
                if dynamical_attribute in dict_attributes[form_in]:
                    if dict_attributes[form_in][dynamical_attribute]:
                        output = True
                        break
            if output:
                break
