...
def get_atom_index(molecular_system, target, indices, structure_indices):

    form_in

    output = dict_get[form]['atom_index'](item, indices=indices, structure_indices=structure_indices)

    return output

get_selector['atom_index']=get_atom_index

def get_argument(molecular_system, target, argument, indices, structure_indices):

    argument = digest_argument(argument, target)

    return get_selector[argument](molecular_system, target, indices, structure_indices)
...
def item_has_attribute(attribute):
