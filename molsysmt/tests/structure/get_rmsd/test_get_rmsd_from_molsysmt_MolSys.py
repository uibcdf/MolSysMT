...
def test_get_rmsd_molsysmt_MolSys_1():
    ...
    check_value_1 = np.allclose(true_value_1, msm.pyunitwizard.get_value(rmsd, to_unit='nm'))
...
def test_get_rmsd_molsysmt_MolSys_2():
    ...
    check_value_1 = np.allclose(true_value_1, msm.pyunitwizard.get_value(rmsd[1000:1010], to_unit='nm'))
    assert check_value_1
...
def test_get_rmsd_molsysmt_MolSys_3():
    ...
    rmsd = msm.structure.get_rmsd(molsys_1, selection='backbone', structure_indices=80,
                ...
                reference_structure_indices=20)
