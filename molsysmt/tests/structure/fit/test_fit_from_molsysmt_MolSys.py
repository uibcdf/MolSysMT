...
def test_fit_molsysmt_MolSys_1():
    ...
    fitted_molsys = msm.structure.least_rmsd_fit(molsys, selection_fit='backbone', reference_structure_index=0)
    fitted_rmsd = msm.structure.get_rmsd(fitted_molsys, selection='backbone', reference_structure_index=0)
