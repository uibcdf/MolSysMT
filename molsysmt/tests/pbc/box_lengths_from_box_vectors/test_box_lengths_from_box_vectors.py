...
def test_box_lengths_from_box_vectors_cubic_geometry():
...
def test_box_lengths_from_box_vectors_octahedral_geometry():
    molsys = msm.convert(msm.demo['Met-enkephalin']['vacuum.msmpk'], to_form='molsysmt.MolSys')
...
def test_box_lengths_from_box_vectors_dodecahedral_geometry():
    molsys = msm.convert(msm.demo['Met-enkephalin']['vacuum.msmpk'], to_form='molsysmt.MolSys')
