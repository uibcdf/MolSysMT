...
#@digest()
def show_contacts(view, selection=None, groups_of_atoms=None, group_behavior=None, structure_indices="all",
                 selection_2=None, groups_of_atoms_2=None, group_behavior_2=None, structure_indices_2=None,
                 threshold='12 angstroms', pbc=False, syntax='MolSysMT',
                 color='#808080', color2='#808080', radius='0.2 angstroms'):
