...
def to_molsysmt_MolSys(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.native.io.molsys.files import from_file_msmpk as file_msmpk_to_molsysmt_MolSys
...
def aux_get(item, indices='all', frame_indices='all'):
    ...
    module = importlib.import_module('molsysmt.forms.classes.api_molsysmt_MolSys')
