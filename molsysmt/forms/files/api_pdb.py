...
def to_parmed_Structure(item, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.classes.api_parmed_Structure import extract_subsystem as extract_parmed
...
def to_mdanalysis_Universe(item, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.classes.api_mdtraj_Universe import extract_subsystem as extract_universe
...
def to_mdtraj_Trajectory(item, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.classes.api_mdtraj_Trajectory import extract_subsystem as extract_mdtraj_trajectory
...
def to_openmm_Topology(item, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.classes.api_openmm_Topology import extract_subsystem as extract_openmm_topology
...
def to_openmm_Modeller(item, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.classes.api_openmm_Modeller import extract_subsystem as extract_modeller
...
def to_openmm_PDBFile(item, atom_indices='all', frame_indices='all'):
    ...
    from simtk.openmm.app.pdbfile import PDBFile
    from molsysmt.forms.classes.api_openmm_PDBFile import extract_subsystem as extract_pdbfile
    tmp_item = PDBFile(item)
...
def to_pdbfixer_PDBFixer(item, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.classes.api_pdbfixer_PDBFixer import extract_subsystem as extract_pdbfixer
