...
def to_openmm_PDBFile(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    if molecular_system is not None:
        ...
        tmp_molecular_system = None
    tmp_item, tmp_molecular_system = openmm_PDBFile_to_openmm_PDBFile(tmp_item, molecular_system=tmp_molecular_system, atom_indices=atom_indices, frame_indices=frame_indices, copy_if_all=False)
...
def to_string_pdb(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    tmp_item, tmp_molecular_system = string_pdb_to_string_pdb(tmp_item, molecular_system=tmp_molecular_system, atom_indices=atom_indices, frame_indices=frame_indices)
...
def extract_item(item, atom_indices='all', frame_indices='all', output_filename=None):
    ...
    if (atom_indices is 'all') and (frame_indices is 'all'):
        ...
        from molsysmt.forms.classes.api_mdtraj_Trajectory import to_file_pdb as mdtraj_Trajectory_to_file_pdb
