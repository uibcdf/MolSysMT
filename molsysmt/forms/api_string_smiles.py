...
def to_rdkit_Mol(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_rdkit_Mol import to_rdkit_Mol as rdkit_Mol_to_rdkit_Mol
...
def to_openff_Molecule(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_openff_Molecule import to_openff_Molecule as openff_Molecule_to_openff_Molecule
