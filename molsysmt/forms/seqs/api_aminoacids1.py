...
def to_fasta(item, output_filepath=None, atom_indices='all', frame_indices='all'):
    ...
    return SeqRecord_to_fasta(tmp_item, output_filepath)

def to_pir(item, output_filepath=None, id=None, style=None, atom_indices='all', frame_indices='all'):
    ...
    return SeqRecor_to_pir(tmp_item, output_filepath=output_filepath, style=style)
