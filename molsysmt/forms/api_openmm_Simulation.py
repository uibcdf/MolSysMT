...
def to_openmm_Topology(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_openmm_Topology import openmm_Topology_to_openmm_Topology
...
def to_file_pdb(item, molecular_system=None, atom_indices='all', frame_indices='all', output_filename=None):
    ...
    from molsysmt.forms.api_openmm_Topology import to_file_pdb as openmm_Topology_to_file_pdb
