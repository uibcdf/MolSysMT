...
def to_openmm_Topology(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    tmp_item, tmp_molecular_system = to_mdtraj_Topology(item, molecular_system=molecular_system, atom_indices=atom_indices, frame_indices=atom_indices)
...
def to_openmm_Modeller(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_mdtraj_Trajectory import to_openmm_Modeller as mdtraj_Trajectory_to_openmm_Modeller

    tmp_item, tmp_molecular_system = to_mdtraj_Trajectory(item, molecular_system=molecular_system, atom_indices=atom_indices, frame_indices=atom_indices)
...
def to_file_mol2(item, molecular_system=None, atom_indices='all', frame_indices='all', output_filename=None, copy_if_all=True):
...
def aux_get(item, indices='all', frame_indices='all'):
    ...
    if 'mdtraj.Trajectory' in forms:
        ...
        module = importlib.import_module('molsysmt.forms.api_mdtraj_Trajectory')
