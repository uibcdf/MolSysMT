...
form_name='str:aminoacids3'

is_form={
        'str:aminoacids3' : form_name,
}
...
def to_str_aminoacids1(item, molecular_system, atom_indices='all', frame_indices='all'):
...
def to_str_aminoacids3(item, molecular_system, atom_indices='all', frame_indices='all', copy_if_all=True):
