...
def to_mdtraj_Trajectory(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_mdtraj_Trajectory import mdtraj_Trajectory_to_mdtraj_Trajectory
...
def to_mdtraj_Topology(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_openmm_Topology import to_mdtraj_Topology as openmm_Topology_to_mdtraj_Topology
...
def to_nglview_NGLWidget(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_mdtraj_Trajectory import to_nglview_NGLWidget as mdtraj_Trajectory_to_nglview_NGLWidget
