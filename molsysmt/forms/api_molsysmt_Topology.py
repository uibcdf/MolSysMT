...
def to_string_aminoacids3(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.native.io.topology import to_string_aminoacids3 as molsysmt_Topology_to_string_aminoacids3
...
def to_string_aminoacids1(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.native.io.topology import to_string_aminoacids1 as molsysmt_Topology_to_string_aminoacids1
...
def to_file_pdb(item, molecular_system=None, atom_indices='all', frame_indices='all', output_filename=None):
    ...
    from molsysmt.native.io.topology import to_file_pdb as molsysmt_Topology_to_file_pdb
