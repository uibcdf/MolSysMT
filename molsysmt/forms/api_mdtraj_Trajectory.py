...
def to_string_aminoacids3(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_mdtraj_Topology import to_string_aminoacids3 as mdtraj_Topology_to_string_aminoacids3
...
def to_string_aminoacids1(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_mdtraj_Topology import to_string_aminoacids1 as mdtraj_Topology_to_string_aminoacids1
...
def to_openmm_Topology(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_mdtraj_Topology import to_openmm_Topology as mdtraj_Topology_to_openmm_Topology
...
def to_parmed_Structure(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.forms.api_openmm_Topology import to_parmed_Structure as openmm_Topology_to_parmed_Structure
