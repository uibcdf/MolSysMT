...
def get_group_index_from_group(item, indices='all', frame_indices='all'):     # EMPTY
...
def get_component_index_from_component (item, indices='all', frame_indices='all'):     # EMPTY
