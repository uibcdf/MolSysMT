...
def to_molsysmt_Topology(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.native.io.topology.classes import from_openff_Molecule as openff_Molecule_to_molsysmt_Topology

    tmp_item, tmp_molecular_system = openff_Molecule_to_molsysmt_Topology(item,
            molecular_system=molecular_system, atom_indices='all', frame_indices='all')

    return tmp_item, tmp_molecular_system

def to_molsysmt_Trajectory(item, molecular_system=None, atom_indices='all', frame_indices='all'):

    from molsysmt.native.io.trajectory.classes import from_openff_Molecule as openff_Molecule_to_molsysmt_Trajectory
...
def to_molsysmt_MolSys(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from molsysmt.native.io.topology.classes import from_openff_Molecule as openff_Molecule_to_molsysmt_MolSys

    tmp_item, tmp_molecular_system = openff_Molecule_to_molsysmt_MolSys(item,
            molecular_system=molecular_system, atom_indices='all', frame_indices='all')
...
def to_openff_Topology(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    from .api_openff_Topology import to_openff_Topology as openff_Topology_to_openff_Topology

    tmp_item = item.to_topology()
    ...
    tmp_item, tmp_molecular_system = openff_Topology_to_openff_Topology(tmp_item,
...
def to_openff_Topology(item, molecular_system=None, atom_indices='all', frame_indices='all'):
    ...
    tmp_item, tmp_molecular_system = to_openff_Topology(item, molecular_system=molecular_system)
    tmp_item, tmp_molecular_system = openff_Topology_to_openmm_Topology(item,
            molecular_system=tmp_molecular_system, atom_indices=atom_indices,
            frame_indices=frame_indices)

    return tmp_item, tmp_molecular_system

def to_openff_Molecule(item, molecular_system=None, atom_indices='all', frame_indices='all', copy_if_all=True):
