...
import numpy as _np
from molsysmt import get as _get, select as _select, convert as _convert
...
def _coordinates(item=None, atom_indices=None, frames_list=None, form='molsysmt.MolSys'):
