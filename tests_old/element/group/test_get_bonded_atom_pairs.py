...
def test_get_bonded_atom_pairs1():
    ...
    pairs = msm.element.group.get_bonded_atom_pairs('NH4', ['N', 'HN1', 'HN2', 'HN3', 'HN4']) 
...
def test_get_bonded_atom_pairs3():
    ...
    pairs = msm.element.group.get_bonded_atom_pairs('K', 'K') 

    assert len(pairs)==0

def test_get_bonded_atom_pairs4():

    atom_names = ['N','CA','C','O','CB','CG1','CG2','OXT','H','HN2','HA','HB',
                  '1HG1','2HG1','3HG1','1HG2','2HG2','3HG2','HXT']
    pairs = msm.element.group.get_bonded_atom_pairs('VAL', atom_names)
...
def test_get_bonded_atom_pairs5():

    atom_names = ['N','CA','C','O','CB','CG1','CG2','OXT','H','HN2','HA','HB',
                  '1HG1','2HG1','3HG1','1HG2','2HG2','3HG2','HXT']
    atom_indices = list(range(10, 10+len(atom_names)))
    pairs = msm.element.group.get_bonded_atom_pairs('VAL', atom_names, atom_indices=atom_indices)
...
def test_get_bonded_atom_pairs6():

    atom_names = ['N','CA','C','O','CB','CG','ND1','CD2','CE1','NE2','OXT']
    pairs = msm.element.group.get_bonded_atom_pairs('HIS', atom_names)
