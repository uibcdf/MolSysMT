...
def add_missing_hydrogens(item, pH=7.4, forcefield='AMBER99SB-ILDN', engine'OpenMM', verbose=False):
    ...
    - OpenMM: The protonation state is determined according the frequency of the
    variant at the specified pH, and the participation of Cysteines in disulfide bonds or
    Histidines in hydrogen bonds. This engine needs the specification of a forcefield. See the
    [OpenMM User Manual](http://docs.openmm.org/7.0.0/userguide/application.html#adding-hydrogens) or the [OpenMM Api Guide](http://docs.openmm.org/development/api-python/generated/simtk.openmm.app.modeller.Modeller.html#simtk.openmm.app.modeller.Modeller.addHydrogens).

    - PDBFixer: The protonation state is determined according to the frequency of the variant at
      the specified pH. See the [PDBFixer
    ...
    engine: str ('OpenMM' or 'PDBFixer'), default: 'OpenMM'
        Name of the engine used to add the missing hydrogens. The following options are available:
            - 'OpenMM': The method openmm.app.modeller.Modeller.addHydrogens is included in the
              workflow. See the [OpenMM User Manual](http://docs.openmm.org/7.0.0/userguide/application.html#adding-hydrogens) or the [OpenMM Api Guide](http://docs.openmm.org/development/api-python/generated/simtk.openmm.app.modeller.Modeller.html#simtk.openmm.app.modeller.Modeller.addHydrogens).
            - 'PDBFixer': The method pdbfixer.PDBFixer.addMissingHydrogens() is included in the
              workflow. See the [PDBFixer Manual](http://htmlpreview.github.io/?https://raw.github.com/pandegroup/pdbfixer/master/Manual.html).
