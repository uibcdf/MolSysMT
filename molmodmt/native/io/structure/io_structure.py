...
def from_gromacs_Topology(item, atom_indices='all', frame_indices='all'):
...
def from_molmod_Topology(item, atom_indices='all', frame_indices='all'):

    from molmodmt import extract as _extract
    from parmed import load_topology as _parmed_load_topology
    tmp_item=_parmed_load_topology(item)
    tmp_item=_extract(tmp_item, selection=atom_indices, frame_indices='all')
    return tmp_item
