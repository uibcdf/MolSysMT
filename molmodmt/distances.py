    ...
    if engine=='MolModMT':
        ...
        if crossed_frames is False:
            if nframes_1 != nframes_2:
                raise ValueError("Both list of frames frame_indices_1 and frame_indices_2 have to have the same number of frames.")
            else:
...
def distance_between_pairs(item_1=None, selection_1="all", selection_groups_1=None, group_behavior_1=None, frame_indices_1="all",
                           item_2=None, selection_2=None, selection_groups_2=None, group_behavior_2=None, frame_indices_2=None,
                           crossed_frames=False, pbc=False, parallel=False, output_form='tensor', engine='MolModMT', syntaxis='MDTraj'):
