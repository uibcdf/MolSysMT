...
def from_h5(item, trajectory_item=None, atom_indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_h5 import to_mdtraj_Topology as h5_to_mdtraj_Topology
