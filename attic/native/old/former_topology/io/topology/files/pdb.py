def to_pdb(item, output_filepath=None, trajectory_item=None, atom_indices='all',
    ...
    from molsysmt.api_forms.api_openmm_Topology import to_pdb as openmm_Topology_to_pdb
...
def from_pdb(item, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_pdb import to_openmm_PDBFile as pdb_to_openmm_PDBFile
