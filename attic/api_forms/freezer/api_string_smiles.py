...
def to_molsysmt_Topology(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.native.io.topology import from_string_smiles as string_smiles_to_molsysmt_Topology
...
def to_molsysmt_MolSys(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    from molsysmt.native.io.molsys import from_string_smiles as string_smiles_to_molsysmt_MolSys
...
def to_rdkit_Mol(item, molecular_system=None, atom_indices='all', structure_indices='all'):

    from rdkit import Chem
    from molsysmt.api_forms.api_rdkit_Mol import to_rdkit_Mol as rdkit_Mol_to_rdkit_Mol

    tmp_item = Chem.MolFromSmiles(item)
    tmp_item = rdkit_Mol_to_rdkit_Mol(tmp_item, atom_indices=atom_indices, structure_indices=structure_indices, copy_if_all=False)
...
def to_openff_Molecule(item, molecular_system=None, atom_indices='all', structure_indices='all'):
    ...
    tmp_item = openff_Molecule_to_openff_Molecule(tmp_item, atom_indices=atom_indices, structure_indices=structure_indices, copy_if_all=False)
...
def to_string_smiles(item, molecular_system=None, atom_indices='all', structure_indices='all', copy_if_all=True):
