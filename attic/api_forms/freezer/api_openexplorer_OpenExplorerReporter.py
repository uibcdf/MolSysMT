...
def to_molsysmt_MolSys(item, atom_indices='all', structure_indices='all',
    ...
    from molsysmt.native.io.molsys import from_openexplorer_OpenExplorerReporter as convert
    return convert(item, atom_indices=atom_indices, structure_indices=structure_indices)
...
def to_pdb(item,  atom_indices='all', structure_indices='all',
    ...
    tmp_io = StringIO()
    positions = get_coordinates_from_system(item, atom_indices=atom_indices, structure_indices=structure_indices)[0]
    topology = to_openmm_Topology(item, atom_indices=atom_indices, structure_indices=structure_indices)
...
def view_with_NGLView(item, atom_indices='all', structure_indices='all',
               topology_item=None, trajectory_item=None, coordinates_item=None, box_item=None):

    from molsysmt.api_forms.api_molsysmt_MolSys import to_NGLView as convert
...
def get_atom_index_from_atom(item, indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_index_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
...
def get_atom_id_from_atom(item, indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_id_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_name_from_atom(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_name_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_type_from_atom(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_type_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_index_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_index_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_id_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_id_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_name_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_name_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_type_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_type_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_name_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_name_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_index_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_index_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_id_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_id_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_type_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_type_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_name_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_name_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_index_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_index_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_id_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_id_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_type_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_type_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_index_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_index_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_id_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_id_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_name_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_name_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_type_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_type_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_index_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_index_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_id_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_id_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_name_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_name_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_type_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_type_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_atoms_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_atoms_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_groups_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_groups_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_components_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_components_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_molecules_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_molecules_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_chains_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_chains_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_entities_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_entities_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_bonded_atoms_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_bonded_atoms_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_bonded_index_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_bonded_index_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_bonds_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_bonds_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_inner_bonded_atoms_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_inner_bonded_atoms_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_inner_bonds_from_atom (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_inner_bonds_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_mass_from_atom(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_mass_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_charge_from_atom(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_charge_from_atom as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)
...
def get_atom_index_from_group(item, indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_index_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_id_from_group(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_id_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_name_from_group(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_name_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_type_from_group(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_type_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_index_from_group(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_index_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_id_from_group(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_id_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_name_from_group(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_name_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_type_from_group(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_type_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_name_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_name_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_index_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_index_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_id_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_id_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_type_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_type_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_name_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_name_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_index_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_index_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_id_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_id_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_type_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_type_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_index_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_index_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_id_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_id_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_name_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_name_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_type_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_type_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_index_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_index_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_id_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_id_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_name_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_name_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_type_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_type_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_atoms_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_atoms_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_groups_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_groups_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_components_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_components_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_molecules_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_molecules_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_chains_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_chains_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_entities_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_entities_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_bonds_from_group (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_bonds_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_mass_from_group(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_mass_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_charge_from_group(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_charge_from_group as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_coordinates_from_group(item, indices='all', structure_indices='all'):
...
def get_atom_index_from_component(item, indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_index_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_id_from_component(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_id_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_name_from_component(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_name_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_type_from_component(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_type_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_index_from_component(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_index_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_id_from_component(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_id_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_name_from_component(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_name_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_type_from_component(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_type_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_name_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_name_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_index_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_index_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_id_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_id_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_type_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_type_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_name_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_name_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_index_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_index_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_id_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_id_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_type_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_type_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_index_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_index_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_id_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_id_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_name_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_name_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_type_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_type_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_index_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_index_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_id_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_id_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_name_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_name_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_type_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_type_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_atoms_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_atoms_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_groups_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_groups_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_components_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_components_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_molecules_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_molecules_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_chains_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_chains_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_entities_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_entities_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_bonds_from_component (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_bonds_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_mass_from_component(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_mass_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_charge_from_component(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_charge_from_component as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_coordinates_from_component(item, indices='all', structure_indices='all'):
...
def get_atom_index_from_molecule(item, indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_index_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_id_from_molecule(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_id_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_name_from_molecule(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_name_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_type_from_molecule(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_type_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_index_from_molecule(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_index_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_id_from_molecule(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_id_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_name_from_molecule(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_name_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_type_from_molecule(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_type_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_name_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_name_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_index_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_index_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_id_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_id_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_type_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_type_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_name_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_name_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_index_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_index_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_id_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_id_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_type_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_type_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_index_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_index_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_id_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_id_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_name_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_name_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_type_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_type_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_index_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_index_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_id_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_id_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_name_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_name_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_type_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_type_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_atoms_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_atoms_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_groups_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_groups_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_components_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_components_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_molecules_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_molecules_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_chains_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_chains_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_entities_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_entities_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_bonds_from_molecule (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_bonds_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_mass_from_molecule(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_mass_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_charge_from_molecule(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_charge_from_molecule as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_coordinates_from_molecule(item, indices='all', structure_indices='all'):
...
def get_atom_index_from_chain(item, indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_index_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_id_from_chain(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_id_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_name_from_chain(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_name_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_type_from_chain(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_type_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_index_from_chain(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_index_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_id_from_chain(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_id_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_name_from_chain(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_name_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_type_from_chain(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_type_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_name_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_name_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_index_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_index_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_id_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_id_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_type_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_type_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_name_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_name_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_index_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_index_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_id_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_id_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_type_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_type_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_index_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_index_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_id_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_id_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_name_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_name_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_type_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_type_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_index_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_index_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_id_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_id_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_name_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_name_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_type_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_type_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_atoms_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_atoms_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_groups_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_groups_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_components_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_components_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_molecules_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_molecules_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_chains_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_chains_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_entities_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_entities_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_bonds_from_chain (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_bonds_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_mass_from_chain(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_mass_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_charge_from_chain(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_charge_from_chain as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_coordinates_from_chain(item, indices='all', structure_indices='all'):
...
def get_atom_index_from_entity(item, indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_index_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_id_from_entity(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_id_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_name_from_entity(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_name_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_type_from_entity(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_type_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_index_from_entity(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_index_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_id_from_entity(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_id_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_name_from_entity(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_name_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_group_type_from_entity(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_group_type_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_name_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_name_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_index_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_index_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_id_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_id_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_component_type_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_component_type_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_name_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_name_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_index_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_index_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_id_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_id_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_chain_type_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_chain_type_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_index_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_index_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_id_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_id_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_name_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_name_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_molecule_type_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_molecule_type_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_index_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_index_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_id_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_id_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_name_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_name_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_entity_type_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_entity_type_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_atoms_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_atoms_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_groups_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_groups_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_components_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_components_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_molecules_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_molecules_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_chains_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_chains_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_entities_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_entities_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_bonds_from_entity (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_bonds_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_mass_from_entity(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_mass_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_charge_from_entity(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_charge_from_entity as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_coordinates_from_entity(item, indices='all', structure_indices='all'):
...
def get_bonded_atoms_from_system(item, indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import get_bonded_atoms_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_atoms_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_atoms_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_groups_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_groups_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_components_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_components_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_chains_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_chains_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_molecules_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_molecules_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_entities_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_entities_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_bonds_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_bonds_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_aminoacids_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_aminoacids_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_nucleotides_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_nucleotides_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_ions_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_ions_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_waters_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_waters_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_cosolutes_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_cosolutes_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_small_molecules_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_small_molecules_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_peptides_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_peptides_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_proteins_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_proteins_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_dnas_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_dnas_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_rnas_from_system (item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_rnas_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_mass_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_mass_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_charge_from_system(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_charge_from_system as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)
...
def get_frame_from_system(item, indices='all', structure_indices='all'):
    ...
    coordinates = get_coordinates_from_system(item, structure_indices=structure_indices)
    box = get_box_from_system(item, structure_indices=structure_indices)
    step = get_step_from_system(item, structure_indices=structure_indices)
    time = get_time_from_system(item, structure_indices=structure_indices)
...
def get_bond_index_from_bond(item, indices='all', structure_indices='all'):
    ...
    from molsysmt.api_forms.api_molsysmt_Topology import get_bond_index_from_bond as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_bond_order_from_bond(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_bond_order_from_bond as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_bond_type_from_bond(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_bond_type_from_bond as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_atom_index_from_bond(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_atom_index_from_bond as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)

def get_n_bonds_from_bond(item, indices='all', structure_indices='all'):

    from molsysmt.api_forms.api_molsysmt_Topology import get_n_bonds_from_bond as _get
    tmp_item = to_molsysmt_Topology(item)
    return _get(tmp_item, indices=indices, structure_indices=structure_indices)
