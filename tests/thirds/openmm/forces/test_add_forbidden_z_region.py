...
def test_add_forbidden_plane_region_1():

    system = mm.System()
    system.addParticle(atom.element.mass)
    fi = msm.thirds.openmm.forces.add_forbidden_plane_region(system, point='[1,2,3] nm', normal_vector=[1,0,0],
                                                           width='0.5 nm',
    ...
    assert f_pbc==True
    assert f_expression== '0.5*Kf*q^2; q = min(0, d-wf); d = periodicdistance(x, 0, 0, px, 0, 0)'

def test_add_forbidden_plane_region_2():

    system = mm.System()
    system.addParticle(atom.element.mass)
    fi = msm.thirds.openmm.forces.add_forbidden_plane_region(system, point='[1,2,3] nm', normal_vector=[0,1,0],
                                                           width='0.5 nm',
                                                           force_constant = '5000 kilojoules/(mol*nm**2)',
                                                           pbc=False)
    force = system.getForce(0)
    ...
    assert f_pbc==False
    assert f_expression== '0.5*Kf*q^2; q = min(0, d-wf); d = abs(y-py)'

def test_add_forbidden_plane_region_3():
    ...
    fi = msm.thirds.openmm.forces.add_forbidden_plane_region(context, point='[1,2,3] nm', normal_vector=[1,1,1],
                                                           width='0.5 nm',
                                                           force_constant = '5000 kilojoules/(mol*nm**2)',
                                                           pbc=True)
...
def test_add_forbidden_plane_region_4():
    ...
    fi = msm.thirds.openmm.forces.add_forbidden_plane_region(simulation, point='[1,2,3] nm', normal_vector=[1,1,1],
                                                           width='0.5 nm',
                                                           force_constant = '5000 kilojoules/(mol*nm**2)',
                                                           pbc=False)
